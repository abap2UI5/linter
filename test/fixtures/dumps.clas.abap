" stays on the old builder on purpose: this fixture is about the ASSERTs both builders raise (non-released-api does not fire here - a directive for it was dead, and unused-directive said so)
