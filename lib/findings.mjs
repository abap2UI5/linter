...
export function attachSourceFixes(findings, source) {
  return attachSuggestionFixes(attachTargetFixes(attachJsonBindFixes(attachNamespaceFixes(attachUnusedNamespaceFixes(findings, source), source), source), source), source);
}
