...
export const FIXABLE = Object.freeze(['obsolete-binder', 'obsolete-bind-argument', 'obsolete-model-update', 'obsolete-frontend-event', 'unconverted-abap-boolean', 'unescaped-text-in-attribute', 'event-arg-unresolved', 'popover-display-val', 'undeclared-namespace', 'literal-view-slot', 'chain-house-layout', 'escaped-brace-in-backtick', 'lifecycle-is-initial', 'redundant-conv-i', 'trailing-empty-event-arg', 'byte-order-mark', 'crlf-line-ending', 'trailing-whitespace', 'missing-final-newline', 'redundant-init-display', 'binding-to-reference', 'unescaped-brace-in-style', 'collapsed-brace-in-style', 'class-constructor-visibility', 'escape-sequence-in-backtick', 'json-bind-on-scalar-property', 'unknown-control', 'unknown-property', 'unknown-aggregation', 'invalid-property-value', 'unknown-event-parameter', 'unknown-icon', 'frontend-action-unknown-id', 'popover-anchor-unknown-id', 'event-name-case-mismatch', 'unused-namespace-declaration', 'event-arg-default-index', 'event-arg-single-row-table', 'missing-on-navigated-branch', 'separate-lifecycle-ifs', 'binding-to-nonpublic', 'private-app-attribute', 'hardcoded-binding-path', 'external-link-without-target', 'unknown-model', 'uncurated-formatter', 'unknown-frontend-action', 'client-handle-capture', 'missing-view-display-on-navigated', 'unknown-binding-path', 'excess-shut', 'insecure-asset-url', 'loop-work-area-bound', 'live-event-roundtrip']);
