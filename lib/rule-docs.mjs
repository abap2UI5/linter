...
export const RULE_DOCS = {
  ...
  'frozen-view-builder': {
    category: 'abap2ui5',
    summary: 'the class builds its view with the frozen `z2ui5_cl_xml_view`, so the view was not checked at all',
    ...
    example: 'DATA(view) = z2ui5_cl_xml_view=>factory( ).   " frozen — nothing below this line is checked\nview->page( )->button( text = `hi` ).',
  },
  'non-released-api': {
    category: 'abap2ui5',
