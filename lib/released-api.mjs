...
export const RELEASED_OBJECTS = Object.freeze([
  ...
  'z2ui5_if_client',
  'z2ui5_if_ui5_exit',
  // Both released 2026-09 to close docs/removal-plan.md items: the JSON
  // reader apps used to reach into the vendored ajson for, and the two-field
  ...
  // whitelist wins, so neither falls into the src/01 engine or z2ui5_t_
  // table family below.
  'z2ui5_cl_ui5_json',
  'z2ui5_t_02',
]);
