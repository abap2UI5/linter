...
export const KNOWN = new Set(['$schema', 'paths', 'ignore', 'ui5', 'minUi5', 'distribution', 'allow', 'render', 'properties', 'failOn', 'rules', 'baseline', 'badge']);
...
export function loadConfig(file) {
  return parseConfig(file, fs.readFileSync(file, 'utf8'));
}
