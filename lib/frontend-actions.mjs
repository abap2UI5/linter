...
export const FRONTEND_EVENTS = [
  ...
  'BIND_ELEMENT', 'URLHELPER', 'SET_TITLE',
  'SET_FAVICON', 'SET_TITLE_LAUNCHPAD', 'SET_FOCUS', 'SCROLL_TO',
  'SCROLL_INTO_VIEW', 'START_TIMER', 'KEYBOARD_SHORTCUT',
  'PLAY_AUDIO', 'SMART_VARIANT_INIT',
 ...
 *
 *  The five `*_NAV_CONTAINER_TO` names that were remapped into a
 *  CONTROL_BY_ID `to` wire are gone upstream (abap2UI5/abap2UI5#2776), and
 *  with them the only aliases that were not a teardown.
 *
 ...
 *  SCROLL_INTO_VIEW `return` without even a console
...
export const ACTION_ID_SLOTS = {
  set_focus: [0], scroll_to: [0], scroll_into_view: [0],
  binding_call: [0],
