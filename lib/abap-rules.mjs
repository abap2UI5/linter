...
const REBUILDS_A_SLOT = /\w*client\s*->\s*(?:(?:nest2?_)?view_display|popup_display|popover_display)\s*\(/i;
...
function displayPathMethods(src) {
...
const UNBINDABLE_TYPES = ['function', 'object', 'any'];
...
function bindableAnywhere(data, prop) {
