...
export function checkNodes(root, { data, minUi5 = '1.71', allow = [], distribution = 'sapui5', model = null, shape = null, rootFields = null, models = null, jsonPaths = null, fromAbap = false, boundElement = false } = {}) {
