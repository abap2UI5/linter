...
const settle = (findings, source, o) =>
  applyDirectives(applyRules(findings, o.rules, o.file), source, { rules: o.rules, file: o.file });
  ...
  if (!prep.usesBuilder) {
    ...
    if (o.allClasses || app) {
      ...
      if (app) {
        ...
        for (const f of checkAbapRules(source, { data: null, minUi5: o.minUi5, rules: o.rules })) {
